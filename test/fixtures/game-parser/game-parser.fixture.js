...
const simpleGameInput = readFileSync(join(__dirname, "simple-game.fixture.pgn"), "utf-8");
...
const multipleLineGameInput = readFileSync(
  join(__dirname, "multiple-lines-game.fixture.pgn"),
  "utf-8"
);
...
const multipleOneLinersGamesInput = readFileSync(
  join(__dirname, "multiple-one-liners-games.fixture.pgn"),
  "utf-8"
);
...
const multipleLinesAndGamesInput = readFileSync(
  join(__dirname, "multiple-lines-and-games.fixture.pgn"),
  "utf-8"
);
